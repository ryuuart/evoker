...
pub struct MetalContext {
    ...
    pub sk_metal_backend_context: BackendContext,
}
...
impl SkiaStudio {
    ...
    pub fn create_drawing(&self, width: i32, height: i32) -> SkiaDrawing {
        ...
        SkiaDrawing::new(surface)
    }

    pub fn publish_drawing(&self, drawing: &mut SkiaDrawing) {
